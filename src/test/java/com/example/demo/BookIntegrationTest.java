...
public class BookIntegrationTest {
    ...
    void 책_전체_조회_성공() throws Exception {
        ...
        String authorResponse = mockMvc.perform(post("/authors")
                ...
                .getResponse()
                .getContentAsString();
        ApiResponse<AuthorResponseDto> authorResponseDto = objectMapper.readValue(
                authorResponse,
                new TypeReference<ApiResponse<AuthorResponseDto>>() {
                }
        );
    ...
    void 책_단건_조회_성공() throws Exception {
        ...
        ApiResponse<BookResponseDto> bookResponseDto = objectMapper.readValue(
                bookResponse,
